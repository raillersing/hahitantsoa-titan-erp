...
export type Customer = {
  ...
  id_duplicata_date?: string | null;
  id_duplicata_place?: string;
  nif?: string;
  stat?: string;
  rcs?: string;
...
export type DocumentInstance = {
  ...
  customer_civilite?: string;
  customer_birth_date?: string | null;
  customer_birth_place?: string;
  customer_id_type?: string;
  customer_id_number?: string;
  customer_id_issue_date?: string | null;
  customer_id_issue_place?: string;
  customer_id_duplicata_date?: string | null;
  customer_id_duplicata_place?: string;
  customer_nif?: string;
  customer_stat?: string;
  customer_rcs?: string;
