...
from .views import (
    ...
    BillingCreditNoteRetrieveAPIView,
...
urlpatterns = [
    ...
    path(
        "invoices/<uuid:id>/credit-notes/<uuid:credit_note_id>/",
        BillingCreditNoteRetrieveAPIView.as_view(),
        name="billing-invoice-credit-note-detail",
    ),
]
