...
def _build_mock_preview_context(template_definition, *, party_type: str = "individual") -> dict:
    ...
    reservation_context = {
        ...
        "reservation_draft": {
            ...
            "customer_birth_date": mock_customer["birth_date"],
            "customer_birth_place": mock_customer["birth_place"],
            "customer_id_type": mock_customer["id_type"],
            "customer_id_number": mock_customer["id_number"],
            "customer_id_issue_date": mock_customer["id_issue_date"],
            "customer_id_issue_place": mock_customer["id_issue_place"],
            "customer_id_duplicata_date": mock_customer["id_duplicata_date"],
            "customer_id_duplicata_place": mock_customer["id_duplicata_place"],
            ...
            "lines": mock_lines,
            "total_amount": "0,00",
            "total_amount_in_words": "Zéro Ariary",
            "sub_total": "0,00",
            "discount": "0,00",
            "caution_amount": "0,00",
            "remaining_due": "0,00",
