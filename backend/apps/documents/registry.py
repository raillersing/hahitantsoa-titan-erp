...
DOCUMENT_TEMPLATE_REGISTRY: tuple[DocumentTemplateDefinition, ...] = (
    DocumentTemplateDefinition(
        ...
        source_reference="docs/references/source/Document_B_Presentation_Metier_Evenementiel_v3.3.pdf",
    ...
    DocumentTemplateDefinition(
        ...
        status="validated_source_template",
        source_kind="source_pdf",
        source_reference="docs/references/source/Document_A_CDC_Technique_Evenementiel_v3.3.pdf",
